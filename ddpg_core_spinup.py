...
# the layer weights initialization changed
def mlp(x, hidden_sizes=(32,), activation=tf.tanh, output_activation=None):
    ...
    return tf.layers.dense(x, units=hidden_sizes[-1], activation=output_activation, kernel_initializer=initializer_xavier)
